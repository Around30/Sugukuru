...
public class Dao
{
	...
	{
		return executeGet("select corporation_id, corporation_account_id, corporation_name from corporation_t, corporation_account_t where corporation_account_id = ? and password = ? and corporation_t.", id, passwd);
	}
